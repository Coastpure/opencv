...
def  getContours(img):
    ...
    for cnt in contours:
        ...
        if area>500:
            ...
            cv2.rectangle(imgContours,(x,y),(x+w,y+h),(0,255,0),2)#bounding boxes
...
imgBlur = cv2.GaussianBlur(imgGray,(7,7),1)#blur the grayscale
imgCanny = cv2.Canny(imgBlur,50,50)#show edges
